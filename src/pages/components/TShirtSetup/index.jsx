...
export const TShirtSetup = ({onTypeChange, onColorChange, onPrintChange }) => {
  return (  
    <form className="tshirt-setup">
      ...
      <select onChange={(event)=>onTypeChange(event.target.value)} className="tshirt-setup__input">
      ...
      <select onChange={(event) => onColorChange(event.target.value)} className="tshirt-setup__input">
